...
<form action="process.php" method="post">
          <div>
            <input type="email" name="mail" id="zone-email" required="" class="border w-full py-2 px-2" placeholder="Entrez l'adresse email">
            <div id="affiche-mdp" class="hidden transition-opacity duration-500 ease-in-out">
              <input type="password" name="passw" id="zone-password" required="" class="border w-full py-2 px-2 mt-3 testpss " placeholder="Entrez le mot de passe">
            </div>
